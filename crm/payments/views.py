...
from .models import Payments,EMI,Transaction
...
# os.environ["G_DEBG"] = "fatal_warnings"
...
class StudentPaymentListView(View):
    ...
    def get(self,request,*args,**kwargs):
        ...
        payment = Payments.objects.get(student=request.user.students,course=request.user.students.course)
...
class PaymentVerifyView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        transaction.transcation_at = timezone.now()
